      ...
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="text-xs tracking-widest text-white/50">
            EXECUTION LAB CHECKOUT
          </div>
          <div className="text-5xl font-semibold tracking-tight">
            ${PRICES[tier]} <span className="text-white/60 text-2xl">USD</span>
          </div>
          <div className="text-sm text-white/60">
            Confirm payment to activate <span className="text-white font-semibold">{tier}</span> access.
          </div>
        </div>
          ...
          {!deposit && (
            <>
              <div className="text-xs text-white/60">
                Choose network and create a secure deposit invoice.
              </div>
              ...
              <button
                ...
                className="w-full rounded-2xl border border-white/20 bg-white/10 py-4
                           text-sm font-semibold tracking-widest hover:bg-white/20 transition disabled:opacity-40"
              >
          ...
          {deposit && (
            <>
              <div className="text-xs text-white/60">
                ...
                Do not close this page until confirmation.
              </div>

              <div className="text-sm">
                <span className="text-white/50">Amount:</span>{" "}
                <span className="font-semibold">${PRICES[tier]} USD</span>
              </div>
